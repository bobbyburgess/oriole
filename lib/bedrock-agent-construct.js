...
class BedrockAgentConstruct extends Construct {
  constructor(scope, id, props) {
    ...
    // Agent Alias Management - REMOVED FROM CDK
    // Aliases are managed manually to avoid CloudFormation drift issues
    // Use setup-agent-ids.sh script to discover and store alias IDs
    // CloudFormation cannot reliably manage Bedrock agent aliases due to API limitations
