...
class OrioleStack extends cdk.Stack {
  constructor(scope, id, props) {
    ...
    // Catches throttling errors and logs them as experiment failures
    ...
    // Start -> Cooldown (from param store) -> InvokeAgent -> CheckProgress -> Choice
    ...
    const experimentTriggerRule = new events.Rule(this, 'ExperimentTriggerRule', {
      ...
      description: 'Trigger Oriole grid exploration experiments'
    });
