...
class OrioleStack extends cdk.Stack {
  constructor(scope, id, props) {
    ...
    // Import existing Cognito User Pool (you mentioned it already exists)
    // You'll need to provide the User Pool ID
    const userPoolId = new cdk.CfnParameter(this, 'CognitoUserPoolId', {
      type: 'String',
      description: 'Existing Cognito User Pool ID'
    });

    const userPoolClientId = new cdk.CfnParameter(this, 'CognitoUserPoolClientId', {
      type: 'String',
    ...
    const claude35Agent = new BedrockAgentConstruct(this, 'Claude35SonnetAgent', {
      agentName: 'oriole-claude-35-sonnet',
