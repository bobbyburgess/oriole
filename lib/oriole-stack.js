...
class OrioleStack extends cdk.Stack {
  constructor(scope, id, props) {
    ...
    // Grant permission to start and list Step Function executions
    stateMachine.grantStartExecution(queueProcessorLambda);
    stateMachine.grantRead(queueProcessorLambda); // Includes ListExecutions for checking running state
    ...
    // Agent Alias IDs for easy triggering
    new cdk.CfnOutput(this, 'Claude35HaikuAliasId', {
      value: claude35Agent.agentAliasId,
      description: 'Claude 3.5 Haiku Agent Alias ID'
    });

    new cdk.CfnOutput(this, 'Claude3HaikuAliasId', {
      value: claude3Agent.agentAliasId,
      description: 'Claude 3 Haiku Agent Alias ID'
    });

    new cdk.CfnOutput(this, 'NovaMicroAliasId', {
      value: novaMicroAgent.agentAliasId,
      description: 'Amazon Nova Micro Agent Alias ID'
    });

    new cdk.CfnOutput(this, 'NovaLiteAliasId', {
      value: novaLiteAgent.agentAliasId,
      description: 'Amazon Nova Lite Agent Alias ID'
    });

    new cdk.CfnOutput(this, 'NovaProAliasId', {
      value: novaProAgent.agentAliasId,
      description: 'Amazon Nova Pro Agent Alias ID'
    });

    new cdk.CfnOutput(this, 'NovaPremierAliasId', {
      value: novaPremierAgent.agentAliasId,
      description: 'Amazon Nova Premier Agent Alias ID'
    });
