...
class OrioleStack extends cdk.Stack {
  constructor(scope, id, props) {
    ...
    const startStep = new tasks.LambdaInvoke(this, 'StartExperiment', {
      ...
      // Use Parameters to properly inject execution context while preserving input
      // This creates: { input: <original>, executionArn: "...", executionName: "..." }
      payload: sfn.TaskInput.fromObject({
        'input.$': '$',  // Pass entire original input
        'executionArn.$': '$$.Execution.Id',  // Inject execution ARN
        'executionName.$': '$$.Execution.Name'  // Inject execution name
      }),
    ...
    const invokeBedrockAgentStep = new tasks.LambdaInvoke(this, 'InvokeBedrockAgent', {
      ...
      errors: ['States.ALL'], // Catch all errors including timeouts
